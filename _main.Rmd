...
This is the course notes for a *Beginner's R Workshop* run by David Wilkinson. The goal of this workshop is to teach researchers how to use **R** for data analysis. **R** is a free, open-source programming language designed with statistical analysis in mind, and widely used throught many scientific disciplines. This workshop is designed to provide researchers with a strong foundation in **R**'s fundamentals to facilitate their own research projects.
